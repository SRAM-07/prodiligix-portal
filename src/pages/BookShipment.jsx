...
const pickupAddresses = [
  'Rapido Bangalore - Roppen Transportation Service Pvt. Ltd., Spatium Commercio Tower A, Bangalore - 560103',
  'Rapido Mumbai - Roppen Transportation Service Pvt. Ltd., Andheri East, Mumbai - 400069',
];

const deliveryAddresses = [
  'Divya Rudavath - C9RV C3V Kavuri Hills Phase 1, Hyderabad - 500033',
  'Ravi Prakash Gopalan - 12 MG Road, Pune - 411001',
  'Sahil Chhabra - B-24 Sector 63, Noida - 201301',
  'Priya Sharma - 45 Anna Salai, Chennai - 600002',
];
...
export default function BookShipment() {
  ...
  const handleSubmit = () => {
    if (!form.pickupAddress || !form.deliveryAddress || !form.actualWeight) {
      alert('Please fill all required fields — Pickup Address, Delivery Address and Actual Weight');
      return;
    }
    setSubmitted(true);
            ...
            <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-4">
              ...
              <div className="flex gap-2 items-center">
                <select
                  ...
                  className="flex-1 bg-gray-50 border border-gray-200 rounded-lg px-3 py-2.5 text-sm text-gray-700 outline-none">

...
export default function Dashboard() {
  ...
  const serviceData = [
    ...
    },
    {
      title: 'IT Solutions',
      path: '/it-solutions',
      total: Object.values(itCounts).reduce((a, b) => a + b, 0),
      items: [
        { name: 'Resolved', value: itCounts.resolved || 0, fill: '#22c55e' },
        { name: 'In Progress', value: itCounts.in_progress || 0, fill: '#3b82f6' },
        { name: 'Pending', value: itCounts.pending || 0, fill: '#f97316' },
        { name: 'Cancelled', value: itCounts.cancelled || 0, fill: '#ef4444' },
      ]
    },
  ];

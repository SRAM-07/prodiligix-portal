  ...
  const serviceData = [
    {
      ...
      items: [
        {
          name: "Delivered",
          value: shipmentCounts.delivered || 0,
          fill: "#22c55e",
        },
        {
          name: "In Transit",
          value: shipmentCounts.in_transit || 0,
          fill: "#068BC9",
        },
        { name: "Booked", value: shipmentCounts.booked || 0, fill: "#3b82f6" },
        {
          name: "Exceptions",
          value: shipmentCounts.exceptions || 0,
          fill: "#ef4444",
        },
      ],
    },
    {
      ...
      items: [
        {
          name: "Delivered",
          value: stampCounts.delivered || 0,
          fill: "#22c55e",
        },
        {
          name: "In Transit",
          value: stampCounts.in_transit || 0,
          fill: "#068BC9",
        },
        { name: "Pending", value: stampCounts.pending || 0, fill: "#f97316" },
        {
          name: "Cancelled",
          value: stampCounts.cancelled || 0,
          fill: "#ef4444",
        },
      ],
    },
    {
      ...
      items: [
        {
          name: "Accepted",
          value: giftingCounts.accepted || 0,
          fill: "#22c55e",
        },
        {
          name: "Initialized",
          value: giftingCounts.initialized || 0,
          fill: "#9ca3af",
        },
        { name: "Pending", value: giftingCounts.pending || 0, fill: "#f97316" },
        {
          name: "Rejected",
          value: giftingCounts.rejected || 0,
          fill: "#ef4444",
        },
      ],
    },
    {
      ...
      items: [
        {
          name: "Completed",
          value: eventCounts.completed || 0,
          fill: "#22c55e",
        },
        {
          name: "In Progress",
          value: eventCounts.in_progress || 0,
          fill: "#3b82f6",
        },
        {
          name: "Under Review",
          value: eventCounts.under_review || 0,
          fill: "#f97316",
        },
        {
          name: "Cancelled",
          value: eventCounts.cancelled || 0,
          fill: "#ef4444",
        },
      ],
    },
    {
      ...
      total: 0,
      items: [
        { name: "Delivered", value: 0, fill: "#22c55e" },
        { name: "Shipped", value: 0, fill: "#068BC9" },
        { name: "Packed", value: 0, fill: "#06b6d4" },
        { name: "Requested", value: 0, fill: "#8b5cf6" },
      ],
    },
  ];
        ...
        <div className="bg-white border-b border-gray-100 px-6 py-3 flex justify-between items-center sticky top-0 z-40">
          ...
          <div className="flex items-center gap-3">
            ...
            <p className="text-xs font-medium text-gray-600">
              ProDiligix Technologies Pvt. Ltd.
            </p>
          </div>
        </div>
            ...
            {statCards.map((card, i) => (
              ...
              >
                <div className="flex justify-between items-start mb-3">
                  ...
                  <span
                    className={`text-xs font-semibold flex items-center gap-0.5 px-2 py-0.5 rounded-full ${card.up ? "text-green-600 bg-green-50" : "text-red-500 bg-red-50"}`}
                  >
                    {card.up ? (
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-5 flex flex-col justify-center items-center gap-3">
              ...
              <p className="text-xs text-gray-400 text-center">
                Get instant shipping quotes for your shipments
              </p>
              <button
